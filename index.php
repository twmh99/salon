<?php
/**
 * Landing page utama – menampilkan hero, fitur, daftar treatment, CTA.
 */
$pageTitle = 'Reservasi Treatment Kecantikan';
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6 order-lg-1 order-2 reveal">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="/customer/login.php" class="btn btn-rose btn-lg">Book Now</a>
...
<section id="treatments" class="py-5">
    <div class="container">
        ...
        <!-- Grid treatment populer -->
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 mb-5">
            <?php foreach (array_slice($treatments, 0, 6) as $item): ?>
                <div class="col reveal">
                    <div class="treatment-card h-100">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="/customer/booking.php" class="btn btn-outline-rose btn-sm">Reserve</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
        <!-- Tabel lengkap treatment -->
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-lg-5 reveal">
                ...
                <a class="btn btn-rose mt-3" href="/customer/register.php">Mulai Registrasi</a>
            </div>
            <div class="col-lg-7">
